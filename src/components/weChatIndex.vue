<template>
  <div class="wechat-home" @click="closeSomeModal()">
    ...
    <div class="bg-modal" v-if="chatListStore.pictureObj.state || chatListStore.sendRedPackState || chatListStore.enableSendState ||chatListStore.searchRecord
    ...
    <!--禁言列表-->
    <enableSendMsgList v-if="chatListStore.enableSendState"></enableSendMsgList>
    <!--搜索本地聊天记录弹窗-->
    <searchRecord v-if="chatListStore.searchRecord"></searchRecord>
    <!--管理员设置-->
