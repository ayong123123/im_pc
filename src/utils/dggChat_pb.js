...
/**
 * @param {number} value
 * @return {!proto.DggChat.DggChatSingleMessage} returns this
 */
...
/**
 * @param {number} value
 * @return {!proto.DggChat.DggChatGroupMessage} returns this
 */
...
proto.DggChat.DggCommon.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    sendtime: jspb.Message.getFieldWithDefault(msg, 5, 0),
    ...
    reserved: jspb.Message.getFieldWithDefault(msg, 14, "")
  };
...
/**
 * @param {number} value
 * @return {!proto.DggChat.DggCommon} returns this
 */
...
proto.DggChat.DggCommon.prototype.clearSinglemessage = function() {
  return this.setSinglemessage(undefined);
};
...
proto.DggChat.DggCommon.prototype.clearGroupmessage = function() {
  return this.setGroupmessage(undefined);
};
 ...
 * @return {string}
 */
proto.DggChat.DggCommon.prototype.getReserved = function() {
 ...
 * @return {!proto.DggChat.DggCommon} returns this
 */
proto.DggChat.DggCommon.prototype.setReserved = function(value) {
