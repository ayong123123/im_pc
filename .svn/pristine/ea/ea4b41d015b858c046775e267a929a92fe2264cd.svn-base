    ...
    <div class="login">
      ...
      <div class="login_box">
        ...
        <el-form :label-position="labelPosition"  :model="registerForm" status-icon ref="registerForm"  class="demo-ruleForm">
          ...
          <el-form-item label="" v-for="i in indexStore.getParams.data" v-if="i.name=='codec'" :key="i">
          ...
          <el-form-item label="" v-for="i in indexStore.getParams.data" v-if="i.name!='vcode' && i.name !='codec'" :key="i">
            <div class="icon"><i class="iconfont icon-nicheng"></i></div>
