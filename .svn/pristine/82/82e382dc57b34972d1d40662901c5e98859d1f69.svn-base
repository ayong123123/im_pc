    ...
    <transition>
      <div class="look-new-friend-modal">
        <div class="look-new-friend-head">
          <i class="el-icon-close"  @click="setModalState('userInfoState')"></i>
          用户详情
        </div>
        <div class="look-new-friend-detail flex">
          <img v-lazy="userDetail.head_portrait || moren" alt="" class="header_avatar">
        ...
        <div class="other-message-select" v-else @click="addForFriendFn(userDetail.id)">
          添加好友
        </div>
      </div>
    </transition>
